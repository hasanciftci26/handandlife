			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"HandandLife-display": {
								"semanticObject": "HandandLife",
								"action": "display",
								"description": "Hand and Life",
								"title": "Hand and Life",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=renova.hl.ui.artisan",
									"url": sap.ui.require.toUrl("renova/hl/ui/artisan")
								}
							}
						}
					}
